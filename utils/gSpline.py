...
class xInterpolatedUnivariateSplineLinear(xInterpolatedUnivariateSpline):
    ...
    Example
    -------
    >>> from GRATools.core.spline import xInterpolatedUnivariateSplineLinear
    >>>
...
class xInterpolatedBivariateSpline(xBivariateSplineBase, RectBivariateSpline):
    ...
    def hprojection(self):
        """Return the horizontal projection of the bivariate spline.
        """
        _x = self.y
        _yo = self.y
        _xo = self.x
