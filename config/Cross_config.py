...
"""Cl VARIABLES
"""
IN_LABEL1 = 'Allyrs_UCV_t56_maskweighted-mE' #the label of the files to be considered
IN_LABEL2 = 'Allyrs_UCV_t56_maskweighted-mW'
MASK_FILE = os.path.join(GRATOOLS_CONFIG, 'fits/Mask_no.fits')
BINNING_LABEL = '13bins'
OUT_LABEL = 'Allyrs_UCV_t56_maskweighted-mE-mW'
